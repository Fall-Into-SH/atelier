...
CREATE SEQUENCE AUT_SEQ
    INCREMENT BY 1;
INSERT INTO AUTHORITY VALUES(AUT_SEQ.nextval,'전체권한',1,1,1,1,1,1);
...
INSERT INTO MEMBER VALUES (0, 'admin@fish.co.kr', '', '없음', '미입력', '미입력', '미입력', '미입력', 'default.png', '실버', '없음', '인증', 1, 0,'default.jpg','소개글을 작성해주세요',sysdate);
-- 회원 시퀀스
